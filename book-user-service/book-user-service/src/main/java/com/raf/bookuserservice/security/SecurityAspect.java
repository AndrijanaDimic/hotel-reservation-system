package com.raf.bookuserservice.security;
...
//com.raf.cinemauserservice.secutiry.CheckSecurity
    @Around("@annotation(com.raf.bookuserservice.security.CheckSecurity)")
